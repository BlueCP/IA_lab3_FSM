...
VL_ATTR_COLD void Vf1_fsm___024root__trace_full_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+5,(vlSelf->f1_fsm__DOT__currentState),32);
    bufp->fullIData(oldp+6,((((((((((0U == vlSelf->f1_fsm__DOT__currentState) 
                              ...
                              ? ((0U == vlSelf->f1_fsm__DOT__currentState)
                                  ? 1U : ((1U == vlSelf->f1_fsm__DOT__currentState)
                                           ? 2U : (
                                                   (2U 
                                                    == vlSelf->f1_fsm__DOT__currentState)
                                                    ? 3U
                                                    : 
                                                   ((3U 
                                                     == vlSelf->f1_fsm__DOT__currentState)
